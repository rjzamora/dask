...
#     chunked = ddf.to_bag(format="frame").map_partitions(
...
#         if split_out == 1:
#             dsk[(tree_reduce_name, p, 0, 0)] = (chunked.name, p)
#             # # Fuse getitem task if split_out is 1
#             # dsk[(tree_reduce_name, p, 0, 0)] = (
#             #     operator.getitem,
#             #     dsk.pop((partition_agg_name, p)),
#             #     0,
#             # )
#         else:
...
#         gb_agg_name, dsk, dependencies=[chunked]
#     )
